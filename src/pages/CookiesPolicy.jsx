    ...
    <div className="py-8">
      <div className="container mx-auto px-4 md:px-20">
        ...
        <div className="bg-white p-6 rounded-b">
          <p>
            ElevenHype.com ("Website," "we," "our," or "us") uses cookies and
            similar tracking technologies to improve user experience, analyze
            site performance, and support marketing efforts. This Cookies Policy
            explains what cookies are, how we use them, and how users can manage
            their cookie preferences.
          </p>
          <p>
            By continuing to use ElevenHype.com, you consent to our use of
            cookies in accordance with this policy. If you do not agree, you can
            disable cookies through your browser settings (explained below).
          </p>
          <h2 className="text-xl font-bold mt-6 mb-2">1. What Are Cookies?</h2>
          <p>
            Cookies are small text files that are placed on your device
            (computer, tablet, or mobile) when you visit a website. Cookies help
            websites recognize your device, store preferences, and improve
            functionality.
          </p>
          <p>
          ...
          <p>We use the following types of cookies on ElevenHype.com:</p>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              They include security, authentication, and session management
              cookies.
            </li>
            <li>Example: Remembering your cookie preferences.</li>
          </ul>
          <h3 className="text-lg font-bold mt-4 mb-2">
          ...
          <ul className="list-disc list-inside">
            <li>
              These cookies help us track Website performance and user
              interactions.
            </li>
            <li>
              We use tools such as Google Analytics to collect anonymized data.
            </li>
            <li>
              Example: Understanding which pages are most popular and improving
              site functionality.
            </li>
          </ul>
          <h3 className="text-lg font-bold mt-4 mb-2">
          ...
          <ul className="list-disc list-inside">
            <li>
              These cookies remember your preferences and settings for a
              personalized experience.
            </li>
            <li>
              Example: Saving your language preference or remembering form
              details.
            </li>
          </ul>
          <h3 className="text-lg font-bold mt-4 mb-2">
          ...
          <ul className="list-disc list-inside">
            <li>
              These cookies help us deliver targeted ads and track their
              effectiveness.
            </li>
            <li>
              They may be placed by third-party advertising partners like
              Facebook Pixel or Google Ads.
            </li>
            <li>
              Example: Showing relevant ads based on your browsing activity.
            </li>
          </ul>
          <h2 className="text-xl font-bold mt-6 mb-2">
          ...
          <ul className="list-disc list-inside">
            <li>Google Analytics (for site performance analysis)</li>
            <li>Facebook Pixel (for targeted advertising)</li>
            <li>YouTube/Vimeo (if embedded videos are played)</li>
            <li>
              Other third-party tracking services for analytics and marketing
            </li>
          </ul>
          <p>
          ...
          <strong>
            <p>
              By using ElevenHype.com, you agree to our use of cookies as
